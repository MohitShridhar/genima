#!/usr/bin/env python
# Credit: Based on https://github.com/huggingface/diffusers/blob/main/examples/controlnet/train_controlnet_sdxl.py
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default="train_controlnet_sdxl_genima",
        help=(
...
def augment_data(args, batch):
    ...
    return {
        ...
        "unet_added_conditions": batch["unet_added_conditions"],
    }
...
def main(args):
    ...
    if args.tiny_vae:
        vae = AutoencoderTiny.from_pretrained("madebyollin/taesdxl")
    else:
